...
const Settings = () => {
    ...
    const validateCurrentPassword = async (password) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_BASE_URL}/api/employee/employee/${userId}`, {
                method: 'GET',
            });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const verifyResponse = await fetch(`${import.meta.env.VITE_BASE_URL}/api/employee/employee/${userId}`, {
                method: 'GET',
                headers: {
            ...
            const response = await fetch(`${import.meta.env.VITE_BASE_URL}/api/employee/update/${userId}`, {
                method: 'PUT',
                headers: {
